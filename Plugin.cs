...
namespace Malia
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        public static string characterName = "Malia";
        public static string heroName = characterName;

        public static string subclassName = "snake"; // needs caps
        ...
        private void Awake()
        {
            ...
            RegisterMod(
                ...
                _author: "binbin",
                _description: "Malia, the snake.",
                _version: PluginInfo.PLUGIN_VERSION,
                _date: ModDate,
                _link: @"https://github.com/binbinmods/Malia",
                _contentFolder: "Malia",
